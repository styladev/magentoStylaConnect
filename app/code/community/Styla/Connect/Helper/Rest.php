...
class Styla_Connect_Helper_Rest
{
     ...
     */
    public function applySearchFilter(Styla_Connect_Model_Resource_Catalog_Product_Collection $collection, Mage_Core_Model_Store $store)
    {
        ...
        Mage::dispatchEvent(self::EVENT_SEARCH_PRODUCTS, array('transport_object' => $transportObject, 'store' => $store, 'search_term' => $searchTerm));
     ...
     * @param Mage_Core_Model_Store $store
     */
    protected function _searchDefaultFulltext(Styla_Connect_Model_Resource_Catalog_Product_Collection $collection, Mage_Core_Model_Store $store)
    {
        $searchTerm = $this->getSearchTerm(); //needed to initialize the catalogsearch query
     ...
     */
    protected function _applySearchFilterOnProductCollection(Styla_Connect_Model_Resource_Catalog_Product_Collection $collection, array $entityIds)
    {
